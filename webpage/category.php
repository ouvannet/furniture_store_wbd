...
<body>
<style>
.grid.grid-cols-1.md:grid-cols-2.lg:grid-cols-3.md:gap-x-4.md:gap-x-8.w-full {
  height: 50px;  /* Adjust the value (e.g., px, rem, em) as needed */
}
  ...
  <div class="relative m-3 flex flex-wrap mx-auto justify-center">
    ...
    <div class="relative max-w-sm min-w-[340px] bg-white shadow-md rounded-3xl p-2 mx-1 my-3 cursor-pointer">
      ...
      <div class="mt-4 pl-2 mb-2 flex justify-between ">
        <div>
          <p class="text-lg font-semibold text-gray-900 mb-0">Bedroom</p>
          <p class="text-md text-gray-800 mt-0">Jump to Bedroom Category</p>
        </div>
        </a>
      </div>
    </div>
    ...
    <div class="relative max-w-sm min-w-[340px] bg-white shadow-md rounded-3xl p-2 mx-1 my-3 cursor-pointer">
      ...
      <div class="mt-4 pl-2 mb-2 flex justify-between ">
        <div>
          <p class="text-lg font-semibold text-gray-900 mb-0">Bathroom</p>
          <p class="text-md text-gray-800 mt-0">Jump to Bathroom Category</p>
        </div>
        </a>
      </div>
    </div>
    ...
    <div class="relative max-w-sm min-w-[340px] bg-white shadow-md rounded-3xl p-2 mx-1 my-3 cursor-pointer">
      ...
      <div class="mt-4 pl-2 mb-2 flex justify-between ">
        <div>
          <p class="text-lg font-semibold text-gray-900 mb-0">Living Room</p>
          <p class="text-md text-gray-800 mt-0">Jump to Living Room Category</p>
        </div>
        </a>
      </div>
    </div>
    ...
    <div class="relative max-w-sm min-w-[340px] bg-white shadow-md rounded-3xl p-2 mx-1 my-3 cursor-pointer">
      ...
      <div class="mt-4 pl-2 mb-2 flex justify-between ">
        <div>
          <p class="text-lg font-semibold text-gray-900 mb-0">Office</p>
          <p class="text-md text-gray-800 mt-0">Jump to Office Category</p>
        </div>
        </a>
      </div>
    </div>
...
<div class="relative max-w-sm min-w-[340px] bg-white shadow-md rounded-3xl p-2 mx-1 my-3 cursor-pointer">
  ...
  <div class="mt-4 pl-2 mb-2 flex justify-between ">
    <div>
      <p class="text-lg font-semibold text-gray-900 mb-0">Kitchen</p>
      <p class="text-md text-gray-800 mt-0">Jump to Kitchen Category</p>
    </div>
    </a>
  </div>
</div>
...
<div class="relative max-w-sm min-w-[340px] bg-white shadow-md rounded-3xl p-2 mx-1 my-3 cursor-pointer">
  ...
  <div class="mt-4 pl-2 mb-2 flex justify-between ">
    <div>
      <p class="text-lg font-semibold text-gray-900 mb-0">Outdoor Furniture</p>
      <p class="text-md text-gray-800 mt-0">Jump to Outdoor furniture Category</p>
    </div>
    </a>
  </div>
</div>
...
<div class="relative max-w-sm min-w-[340px] bg-white shadow-md rounded-3xl p-2 mx-1 my-3 cursor-pointer">
  ...
  <div class="mt-4 pl-2 mb-2 flex justify-between ">
    <div>
      <p class="text-lg font-semibold text-gray-900 mb-0">Deck Furniture</p>
      <p class="text-md text-gray-800 mt-0">Jump to Deck Furniture Category</p>
    </div>
    </a>
  </div>
</div>
